while True:
  try:
    ...
    for caracter in string:
        stringDeslocada = ord(caracter) + 3
        codeToString = chr(stringDeslocada)
        newString += codeToString
        print(string)
...
posições para a direita, segundo a tabela ASCII: letra 'a' deve virar letra 'd', letra 'y' deve virar 
caractere '|' e assim sucessivamente. Na segunda passada, a linha deverá ser invertida. 
